...
//dtos
import { GetCatsTypeIdParamsRequestDto, CatResponeDto, CreateCatRequestDto, UpdateCatRequestDto, UploadImageCatReponseDto, DeletedCatReponseDto } from 'src/common/dtos';
import { Cat, CatDocument } from 'src/common/schemas';
